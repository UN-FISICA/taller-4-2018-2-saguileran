...
class Zeros:
    ...
    def zero(self,vi): 
        ...
        if self.metodo=='newton':return(print(Newton(vi)))
        elif self.metodo=='bisectriz':return(print(Bisection(vi)))
        elif self.metodo=='interpolacion':return(print(Interpol(vi)))
        elif self.metodo=='newton-sp':
            return(print(optimize.newton(self.f,vi,prime=None, tol=self.error, maxiter=self.max_inter, fprime2=None))) #Calcula la derivada con el método de la secante
        elif self.metodo=='fsolve-sp':
            return(print(optimize.fsolve(self.f,vi,xtol=self.max_inter)))
        elif self.metodo=='brentq-sp':pass
